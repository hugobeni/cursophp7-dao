...
class Usuario {
	...
	public function login($login, $password){
		...
		$result = $sql->select("SELECT * FROM tb_usuario WHERE deslogin = :LOGIN AND dessenha = :PASSWORD", array(':LOGIN'=>$login, ':PASSWORD'=>$password));
	...
	public function update($login, $password){
		...
		$sql->query("UPDATE tb_usuario SET deslogin = :LOGIN, dessenha = :PASSWORD WHERE idusuario = :ID", array(':LOGIN'=>$this->getDeslogin(),':PASSWORD'=>$this->getDessenha(),':ID'=>$this->getIdusuario()
	));
	}
